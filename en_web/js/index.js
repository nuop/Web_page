...
mv.app.toBanner = function(){
	...
	var oLi = oAdv.getElementsByTagName('li'); 
	
	var oPrevBg = mv.tools.getByClass(oAdv,'advPrevBg')[0];
	var oNextBg = mv.tools.getByClass(oAdv,'advNextBg')[0];
	var oPrev = mv.tools.getByClass(oAdv,'advPrev')[0];
	var oNext = mv.tools.getByClass(oAdv,'advNext')[0];
